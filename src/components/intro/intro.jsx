    ...
    return (
        <div className="i">
            <div className="i-left">
              <header 
              style={{backgroundColor:darkMode ? "#192229" : "#EFF3F5", color:darkMode ? "#EFF3F5" : "#192229"}}
              className="header"
              >
                <ul>
                ...
                <div className="i-left-wrapper">
                    ...
                    <h2 className="i-name">Julian Ferreyra Mira</h2>
        ...
        >
          <g id="scroll">
            ...
            <div className="i-right">
                ...
                <img src={Concept} alt="" className="i-img" />
            </div>
        </div>
    )
}
